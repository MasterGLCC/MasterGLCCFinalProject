...
@Repository
public interface ProfesseurRepository extends JpaRepository<Professeur, Integer>, JpaSpecificationExecutor<Professeur> {
    default List<Professeur> findByNomOrPrenom(EntityManager entityManager, String c1, String c2, int firstResult, int maxResult) {
        CriteriaBuilder criteriaBuilder = entityManager.getCriteriaBuilder();
        CriteriaQuery<Professeur> criteriaQuery = criteriaBuilder.createQuery(Professeur.class);
        Root<Professeur> root = criteriaQuery.from(Professeur.class);
        ...
        TypedQuery<Professeur> typedQuery = entityManager.createQuery(criteriaQuery);
